...
from retriever import tokenizers
...
db_opts = {'db_path': 'output/retriever/pgt_handbook_paragraph.db'}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--db_path', type=str, default='output/retriever/pgt_handbook_paragraph.db',
                        help='Path to sqlite db holding document texts')
    parser.add_argument('--out_dir', type=str, default='model/retriever',
